...
type PaymentReceived struct {
	...
	Imputation            []InvoicePaymentReceived `gorm:"foreignKey:IDPaymentReceived" json:"Imputation,omitempty"`
	Customer              Customer                 `gorm:"primaryKey:CustomerID" json:"Customer,omitempty"`
}
